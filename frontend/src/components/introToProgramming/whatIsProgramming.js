...
const courseSummaryText = `In this first lesson, we will focus on the programming part of the course, which is as important as the Python part. In fact, it might even be more important in the longer term. I know you cannot wait to sink your teeth into Python… but please be patient and stick with me for now. We will get to Python by the end of the lesson, I promise! <br>
In this lesson, I will be presenting programming from a Computer Science perspective, which may be quite different from how you learnt programming. I will concentrate on the big picture and the core ideas behind programming. It might all seem a bit basic to you but it is quite an important topic. So please, stick with me! <br> 
